export const SelectImagesIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <path fill="#FFC107" fill-rule="nonzero"
                  ...
                  opacity="0.5" transform="rotate(34.64 268.35 153.887)"></path>
            <path fill="#FFC107" fill-rule="nonzero"
                  d="M249.191579 161.852111L265.339079 161.852111 265.339079 177.999611 249.191579 177.999611z"
                  opacity="0.3" transform="rotate(34.64 257.265 169.926)"></path>
            <path fill="#FFF" fill-rule="nonzero"
            ...
            <path fill="#FF4842" fill-rule="nonzero"
                  ...
                  opacity="0.5" transform="rotate(16.29 251.658 150.547)"></path>
            <path fill="#FF4842" fill-rule="nonzero"
                  d="M238.116192 161.182554L254.263692 161.182554 254.263692 177.330054 238.116192 177.330054z"
                  opacity="0.3" transform="rotate(16.29 246.19 169.256)"></path>
            <path fill="#FFF" fill-rule="nonzero"
            ...
            <path fill="#1890FF" fill-rule="nonzero"
                  ...
                  opacity="0.5" transform="rotate(4.6 242.308 150.487)"></path>
            <path fill="#1890FF" fill-rule="nonzero"
                  d="M232.672488 161.846499L248.819988 161.846499 248.819988 177.993999 232.672488 177.993999z"
                  opacity="0.3" transform="rotate(4.6 240.746 169.92)"></path>
            <path fill="#FFF" fill-rule="nonzero"
            ...
            <path fill="#078DEE" fill-rule="nonzero"
            ...
            <path fill="#078DEE" fill-rule="nonzero"
                  ...
                  opacity="0.5" transform="rotate(-2.862 236.39 151.563)"></path>
            <path fill="var(--primary-color)" fill-rule="nonzero"
                  d="M228.525282 163.608968L244.672782 163.608968 244.672782 179.756468 228.525282 179.756468z"
                  opacity="0.3" transform="rotate(-2.61 236.599 171.683)"></path>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <ellipse cx="380.363" cy="298.487" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="8.945"
                     ry="1.513"></ellipse>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <ellipse cx="390.052" cy="264.383" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="5.044"
                     ry="1"></ellipse>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <ellipse cx="346.97" cy="270.022" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="6.09"
                     ry="1.028"></ellipse>
            ...
            <path fill="url(#linearGradient-2)" fill-rule="nonzero"
                  d="M269.277 168.76l-45.767.493a3.127 3.127 0 00-3.094 3.125v3.782a3.127 3.127 0 01-3.05 3.124l-33.024.792a3.124 3.124 0 01-3.095-2.308l-1.551-5.701a3.124 3.124 0 00-3.053-2.308l-44.113.475a3.125 3.125 0 00-3.05 3.648l17.747 104.449a3.129 3.129 0 003.071 2.604l139.363.598a3.129 3.129 0 003.082-3.714l-20.366-106.521a3.125 3.125 0 00-3.1-2.538z"
                  opacity="0.32"></path>
            <ellipse cx="119.593" cy="258.664" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1" rx="4.846"
                     ry="1"></ellipse>
            <ellipse cx="101.03" cy="260.545" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1" rx="4.846"
                     ry="1"></ellipse>
            <ellipse cx="108.459" cy="265.905" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1" rx="3.444"
                     ry="1"></ellipse>
            <ellipse cx="89.193" cy="265.433" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1" rx="3.444"
                     ry="1"></ellipse>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5"
            ...
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5"
                  d="M91.113 247.808s8.353 12.115 9.968 12.647"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5" d="M90.344 249.701L92.293 249.701"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5" d="M92.68 254.132L95.738 254.263"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5" d="M94.542 250.586L94.21 252.179"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5" d="M97.792 255.432L97.732 256.879"></path>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5" d="M111.82 249.701L109.871 249.701"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5"
                  d="M109.485 254.132L106.426 254.263"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5"
                  d="M107.622 250.586L107.954 252.179"></path>
            <path stroke="var(--primary-color)" stroke-linecap="round" stroke-width="0.5"
                  d="M104.372 255.432L104.432 256.879"></path>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <circle cx="84.467" cy="87.003" r="6.467" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="395.425" cy="138.681" r="6.467" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="279.178" cy="66.467" r="6.467" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="97.4" cy="122.68" r="10.838" fill="var(--primary-color)" fill-rule="nonzero" opacity="0.1"></circle>
            <path fill="var(--primary-color)" fill-rule="nonzero"
            ...
            <path fill="var(--primary-color)" fill-rule="nonzero"
                  ...
                  opacity="0.72"></path>
            <path fill="#0351AB" fill-rule="nonzero"
