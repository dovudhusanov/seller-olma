        ...
        <svg width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <linearGradient id="BG" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
                    <stop offset="0%" stop-color="#078DEE"></stop>
                    <stop offset="100%" stop-color="#078DEE" stop-opacity="0"></stop>
                </linearGradient>
            </defs>
            ...
            <path fill="#FF4842" fill-rule="nonzero"
                  ...
                  opacity="0.05"></path>
            <path fill="#012972" fill-rule="nonzero"
            ...
            <path fill="url(#linearGradient-2)" fill-rule="nonzero"
                  d="M269.277 168.76l-45.767.493a3.127 3.127 0 00-3.094 3.125v3.782a3.127 3.127 0 01-3.05 3.124l-33.024.792a3.124 3.124 0 01-3.095-2.308l-1.551-5.701a3.124 3.124 0 00-3.053-2.308l-44.113.475a3.125 3.125 0 00-3.05 3.648l17.747 104.449a3.129 3.129 0 003.071 2.604l139.363.598a3.129 3.129 0 003.082-3.714l-20.366-106.521a3.125 3.125 0 00-3.1-2.538z"
                  opacity="0.32"></path>
            <ellipse cx="119.593" cy="258.664" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="4.846"
                     ry="1"></ellipse>
            <ellipse cx="101.03" cy="260.545" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="4.846"
                     ry="1"></ellipse>
            <ellipse cx="108.459" cy="265.905" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="3.444"
                     ry="1"></ellipse>
            <ellipse cx="89.193" cy="265.433" fill="#078DEE" fill-rule="nonzero" opacity="0.1" rx="3.444"
                     ry="1"></ellipse>
            <path fill="#078DEE" fill-rule="nonzero"
            ...
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5" d="M90.344 249.701L92.293 249.701"></path>
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5" d="M92.68 254.132L95.738 254.263"></path>
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5" d="M94.542 250.586L94.21 252.179"></path>
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5" d="M97.792 255.432L97.732 256.879"></path>
            <path fill="#078DEE" fill-rule="nonzero"
            ...
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5" d="M111.82 249.701L109.871 249.701"></path>
            <path stroke="#012972" stroke-linecap="round" stroke-width="0.5"
            ...
            <circle cx="84.467" cy="87.003" r="6.467" fill="#078DEE" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="395.425" cy="138.681" r="6.467" fill="#078DEE" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="279.178" cy="66.467" r="6.467" fill="#078DEE" fill-rule="nonzero" opacity="0.1"></circle>
            <circle cx="97.4" cy="122.68" r="10.838" fill="#078DEE" fill-rule="nonzero" opacity="0.1"></circle>
            <path fill="#0351AB" fill-rule="nonzero"
